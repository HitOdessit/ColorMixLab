...
>
> Kotlin Multiplatform · Jetpack Compose · SwiftUI · CI · 100+ tests · ADRs. All Kotlin, Swift, Gradle, GitHub Actions, and Markdown in this repo was generated by [Cursor](https://cursor.com) and [Claude Code](https://docs.anthropic.com/en/docs/claude-code) under direct human prompting and review. Read the [retrospective](RETROSPECTIVE.md) for the honest version of what worked and what didn't.
...
> Coming soon. Polished demo video and screenshots are in flight separately.
